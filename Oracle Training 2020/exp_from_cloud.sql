...
/*
oracleidentitycloudservice/akluev@hotmail.com

GyN2tJ.[0;p2;c.{(YKR

https://objectstorage.ca-toronto-1.oraclecloud.com/p/TlG6kORNc1dbRApOghnTftqCDKBPYL8ER0Ga2T1571E/n/yz6tenlj3noa/b/upload/o/
*/
...
BEGIN
  DBMS_CLOUD.CREATE_CREDENTIAL(
    credential_name => 'EXPIMP_CRED_NAME',
    username => 'oracleidentitycloudservice/akluev@hotmail.com',
    password => 'GyN2tJ.[0;p2;c.{(YKR'
  );
END;
/
...
ALTER DATABASE PROPERTY SET DEFAULT_CREDENTIAL = 'ADMIN.EXPIMP_CRED_NAME'
/

select * from user_credentials

--- Install untilmail
pushd C:\oracle\product\19.0.0\client_1\bin

expdp Admin/testDBA2020$@test1_high ^
logfile=bc.log ^
...
sqlplus  Admin/testDBA2020$@test1_high

SELECT * 
FROM table(dbms_cloud.list_files('DATA_PUMP_DIR'))
WHERE object_name LIKE '%.dmp'
/
...
BEGIN
         dbms_cloud.put_object(
             credential_name => 'EXPIMP_CRED_NAME',
             object_uri      => 'https://objectstorage.ca-toronto-1.oraclecloud.com/p/DA4iBGey7hVQMeTVfdGvRV21neEFpzQlTSnwupnofNA/n/yz6tenlj3noa/b/upload/o/',
             directory_name  => 'DATA_PUMP_DIR',
             file_name       => 'exp_bc.dmp'
            ); 
END;
/
...
https://console.ca-toronto-1.oraclecloud.com/object-storage/buckets/yz6tenlj3noa/upload/objects
